...
This error arises from the [diamond composition pattern](guide/directives/directive-composition-api):
...
See [Directive composition API](guide/directives/directive-composition-api)
